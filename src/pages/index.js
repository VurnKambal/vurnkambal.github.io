    ...
    return (
        <>
            ...
            <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
                <Layout className="pt-0 md:pt-16 sm:pt-12">
                    <div className="flex items-center justify-between w-full lg:flex-col">
                        <div className="w-1/2 md:w-full">
                            <Image
                                ...
                                alt="Kent"
                                className="
                                    w-full h-full lg:hidden md:inline-block md:w-full
                                "
                                priority
                                sizes="
                            ...
                            <div className="flex items-center self-start mt-2 lg:self-center">
                                <Link
                                    ...
                                    className="flex items-center bg-dark text-light p-2.5
                                               px-6 rounded-lg text-lg font-semibold capitalize
                                ...
                                <Link
                                    ...
                                    target={"_blank"}
                                    className="
                                        ml-4 text-lg font-medium capitalize text-dark underline hover:text-primary
                                        dark:text-light dark:hover:text-primary md:text-base 
                                    "
                                >
                                    Contact
                                </Link>
