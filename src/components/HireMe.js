    ...
    return (
        ...
        >
            <div className="w-48 h-auto flex items-center justify-center relative md:w-24">
                ...
                <Link
                    href="mailto:vurnkambal@gmail.com"
                    target={"_blank"}
                    className="flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2
                               ...
                               dark:bg-light dark:border-light dark:text-dark dark:hover:bg-dark dark:hover:text-light
                               dark:hover:border-light md:w-12 md:h-12 md:text-[10px]
                               "
                >
                    Hire Me
                </Link>
